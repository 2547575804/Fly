...
public class ShootGame extends JPanel {
    ...
    public static final int HEIGHT = 635; // 面板高
    ...
    static { // 静态代码块，初始化图片资源
        try {
            ...
            hero1 = ImageIO.read(ShootGame.class.getResource("kiana.png"));
            pause = ImageIO.read(ShootGame.class.getResource("pause.png"));
            gameover = ImageIO.read(ShootGame.class.getResource("gameover.jpg"));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
